...
const NFTCard = ({ nft, onProfilePage }) => {
  ...
  return (
    <Link 
      ...
      className="min-w-[215px] max-w-[327px] dark:bg-nft-black-3 bg-white rounded-2xl p-4 m-4 cursor-pointer shadow-md transition-transform transform hover:scale-105"
    >
        <div className="relative w-full h-52 sm:h-36 xs:h-56 minmd:h-60 minlg:h-72 rounded-2xl overflow-hidden">
          <Image 
            src={nft.image || images[`nft${nft.i}`]} 
            fill 
            alt="nft01" 
            sizes="100%" // Simplified sizes prop
