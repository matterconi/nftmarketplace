...
const CreatorCard = ({ rank, creatorImage, creatorName, creatorEths }) => {
  ...
  return (
    <div className="min-w-190 minlg:min-w-240 dark:bg-nft-black-3 bg-white border dark:border-nft-black-3 rounded-3xl flex flex-col p-4 m-4">
      <div className="bg-nft-red-violet rounded-full w-8 h-8 minlg:w-10 minlg:h-10 flexCenter">
