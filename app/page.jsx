      ...
      <div className="dark:bg-nft-dark bg-white min-h-screen">
        ...
        <div className="pt-65">
          ...
          <div className="relative flex-1 max-w-full flex mt-3">
            ...
            {!hideLeftButton && (
              <div className="absolute w-8 h-8 minlg:w-12 minlg:h-12 top-1/2 transform -translate-y-1/2 cursor-pointer left-0" onClick={() => handleScroll('left')}>
                <Image src={images.left}  style={{ objectFit: 'contain' }} alt="left_arrow" className={theme === 'light' ? 'filter invert' : ''} />
              </div>
            )}
            {!hideRightButton && (
          ...
          <div className="mt-10">
            ...
            <div className='mt-3 w-full flex flex-wrap justify-start ZZZmd:justify-center'>
